...
/* Forward prototypes for the closure stubs this file defines (clib -we: no
   implicit function declarations). Guarded definitions below may compile out;
   an unused prototype is harmless. */
int  _ismbblead( unsigned int c );
void __fatal_runtime_error( char __far *msg, int rc );
